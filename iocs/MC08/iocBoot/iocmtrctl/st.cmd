...
epicsEnvSet("LOCATION",  "06BM A-hutch RG:C1")
epicsEnvSet("STREAM_PROTOCOL_PATH", ".:../protocols:$(PMACUTIL)/protocol:/$(PMACCOORD)/protocol")

epicsEnvSet("SYS",           "XF:06BMA-CT")
epicsEnvSet("IOC_ASYN",      "$(SYS){MC:08}")
epicsEnvSet("IOC_PREFIX",    "$(SYS){IOC:MC08}")
epicsEnvSet("CONTROLLER_IP", "xf06bm-mc08")
...
cd ${TOP}
dbl > ./records.dbl
#system "cp ./records.dbl /cf-update/xf06bm-ioc1.mc08.dbl"
