...
drvAsynIPPortConfigure("PI","10.6.130.51:4002",0,0,0)
...
dbLoadRecords("/usr/lib/epics/db/asynRecord.db", "P=XF\:06BM\-CT\{PIE625\},R=Asyn,PORT=PI,IMAX=255,OMAX=255,ADDR=0")
...
PIE625CreateController("PI1", "PI", 2, 100, 1000)

dbLoadRecords("db/iocAdminSoft.db","IOC=XF:06BM-CT{IOC:PI01}")
...
#dbl > "/cf-update/xf06bm-ioc1.PIE625.dbl"
