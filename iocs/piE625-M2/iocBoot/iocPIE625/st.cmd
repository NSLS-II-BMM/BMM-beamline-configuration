...
drvAsynIPPortConfigure("PI","10.6.130.53:4001",0,0,0)
...
dbLoadRecords("/usr/lib/epics/db/asynRecord.db", "P=XF\:06BM\-CT\{PIE625-M2\},R=Asyn,PORT=PI,IMAX=255,OMAX=255,ADDR=0")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:06BM-CT{IOC:PI02}")
...
#dbl > "/cf-update/xf06bm-ioc1.PIE625-M2.dbl"
