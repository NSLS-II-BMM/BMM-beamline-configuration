...
/* Generated from ../O.Common/plc1.dbd */
...
int plc1_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/plc1";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"plc1_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    plc1_registerRecordDeviceDriver(*iocshPpdbbase);
}
