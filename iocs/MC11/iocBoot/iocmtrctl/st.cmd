...
epicsEnvSet("IOC_ASYN",      "$(SYS){MC:11}")
epicsEnvSet("IOC_PREFIX",    "$(SYS){IOC:MC11}")
epicsEnvSet("CONTROLLER_IP", "10.6.130.91")
...
dbLoadRecords("db/pmacEstopStatus.db","SYS=$(SYS),PMAC=MC:11,PORT=P0")
...
cd ${TOP}
dbl > ./records.dbl
#system "cp ./records.dbl /cf-update/xf06BMc-ioc1.mcc11.dbl"
