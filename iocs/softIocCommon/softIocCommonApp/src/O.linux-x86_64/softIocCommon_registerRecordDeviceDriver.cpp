...
/* Generated from ../O.Common/softIocCommon.dbd */
...
int softIocCommon_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/softIocCommon";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"softIocCommon_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    softIocCommon_registerRecordDeviceDriver(*iocshPpdbbase);
}
