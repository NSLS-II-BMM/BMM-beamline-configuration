...
static const char * const deviceSupportNames[108] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[108] = {
...
epicsShareExtern void (*pvar_func_dist_pvsRegistrar)(void);
epicsShareExtern void (*pvar_func_csvSaverRegistrar)(void);
epicsShareExtern void (*pvar_func_csvtxtSaverRegistrar)(void);
epicsShareExtern void (*pvar_func_register_func_pkValsCalc)(void);
...
{
    const char *bldTop = "/opt/epics/modules/SAI";
    ...
    registerDevices(pbase, 108, deviceSupportNames, devsl);
    ...
    (*pvar_func_dist_pvsRegistrar)();
    (*pvar_func_csvSaverRegistrar)();
    (*pvar_func_csvtxtSaverRegistrar)();
    (*pvar_func_register_func_pkValsCalc)();
